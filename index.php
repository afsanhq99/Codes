...
<div class="events-container"
    ...
    <div class="row mb-3 align-items-center">
        ...
        <div class="col-md-6 d-flex align-items-center">
            <a href="create_event.php" class="btn btn-primary"
                style="background-color: #007bff; border: none; padding: 10px 20px; font-size: 16px; border-radius: 4px; color: #fff; margin-right: 40px;">Create
                Event</a>
        </div>
                ...
                <div class="input-group" style="display: flex; flex-wrap: nowrap;">
                    ...
                    <div class="input-group-append">
                        <button type="submit" class="btn btn-secondary"
                            style="background-color: #6c757d; border: none; padding: 10px 20px; font-size: 16px; border-radius: 4px; color: #fff; margin-left: 10px;">
    ...
    <table class="table table-striped" style="margin-top: 20px;">
        <thead>
            <tr>
                <th><a href="?sort=name&order=<?= $sortField == 'name' && $sortOrder == 'ASC' ? 'DESC' : 'ASC' ?>"
                        style="color: #007bff; text-decoration: none;">Name <i class="fas fa-filter"
                            title="Click to sort by Name"></i></a></th>
                <th><a href="?sort=date&order=<?= $sortField == 'date' && $sortOrder == 'ASC' ? 'DESC' : 'ASC' ?>"
                        style="color: #007bff; text-decoration: none;">Date <i class="fas fa-filter"
                            title="Click to sort by Date"></i></a></th>
                <th><a href="?sort=location&order=<?= $sortField == 'location' && $sortOrder == 'ASC' ? 'DESC' : 'ASC' ?>"
                        style="color: #007bff; text-decoration: none;">Location <i class="fas fa-filter"
                            title="Click to sort by Location"></i></a></th>
                <th>Actions</th>
            </tr>
        </thead>
        <tbody>
